...
protocol ApiProtocol {
    func request<T: Decodable>(_ endpoint: EndpointProvider, type: T.Type) async throws -> T
...
final class ApiClient: ApiProtocol {
    ...
    @discardableResult
    func request<T: Decodable>(_ endpoint: any EndpointProvider, type: T.Type) async throws -> T {
        do {
